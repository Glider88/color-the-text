...
readonly class SubjectPredicateTask implements TaskInterface
{
    ...
    {
        $task = <<<TASK
Пройдись по всем предложениям от первого до последнего и найди все подлежащие и скажуемые для каждого предложения. Формат ответа: ничего лишнего, сначала метка потом пробел и само слово, метка для полежащего 1, для сказуемого 2, каждая метка + слово на новой строчке. Вот текст:
